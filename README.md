...
<table>
  <tr>
    <td align="center" width="50%">
      <b>📊 관리자 대시보드</b><br><br>
      <img src="docs/gifs/admin_dashboard.gif" width="480" alt="관리자 대시보드" /><br><br>
      <sub>실시간 매출 통계 · 인기 상품 TOP 5<br>최근 구매 내역 · 전체 사용자 현황</sub>
    </td>
    <td align="center" width="50%">
      <b>📦 상품 관리</b><br><br>
      <img src="docs/gifs/admin_products.gif" width="480" alt="상품 관리 화면" /><br><br>
  ...
  <tr>
    <td align="center" width="50%">
      ...
      <img src="docs/gifs/admin_purchases.gif" width="480" alt="전체 구매 내역" /><br><br>
      <sub>전체 사용자 구매 기록 일괄 조회<br>사용자별 · 날짜별 필터링</sub>
    </td>
    <td align="center" width="50%">
      <!-- 추가 관리자 화면이 생기면 여기에 삽입 -->
    </td>
  </tr>
</table>
